...
// UserFeedbackPage.jsx (Updated with Firebase integration)
import React, { useState } from 'react';
import { Star, Send, Menu, X, User } from 'lucide-react';
  ...
  return (
    <nav className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-10 md:flex md:space-x-8">
              <a href="/events" className="text-gray-500 hover:text-indigo-600 px-3 py-2 font-medium">Events</a>
              <a href="/dashboard" className="text-gray-500 hover:text-indigo-600 px-3 py-2 font-medium">Dashboard</a>
              <a href="/feedback" className="text-indigo-600 border-b-2 border-indigo-600 px-3 py-2 font-medium">Feedback</a>
              <a href="/contact" className="text-gray-500 hover:text-indigo-600 px-3 py-2 font-medium">Contact</a>
            </div>
          </div>
          <div className="flex items-center">
            <div className="hidden md:flex items-center">
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="/events" className="text-gray-500 hover:bg-gray-50 block px-3 py-2 rounded-md">Events</a>
            <a href="/dashboard" className="text-gray-500 hover:bg-gray-50 block px-3 py-2 rounded-md">Dashboard</a>
            <a href="/feedback" className="bg-indigo-50 text-indigo-600 block px-3 py-2 rounded-md">Feedback</a>
            <a href="/contact" className="text-gray-500 hover:bg-gray-50 block px-3 py-2 rounded-md">Contact</a>
            <a href="/profile" className="text-gray-500 hover:bg-gray-50 block px-3 py-2 rounded-md">My Profile</a>
          </div>
        </div>
      )}
    </nav>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {submitted ? (
          <div className="bg-white shadow rounded-lg p-8 text-center">
            ...
            <div className="mt-6">
              <button
                onClick={() => {
                  setSubmitted(false);
                  setFormData({ eventName: '', rating: 0, feedback: '', name: '', email: '' });
                }}
                className="text-indigo-600 hover:text-indigo-800 font-medium"
              >
                Submit another feedback
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="mb-6">
                <label htmlFor="eventName" className="block text-sm font-medium text-gray-700 mb-1">Which event are you rating?</label>
                <select
                  id="eventName"
                  name="eventName"
                  required
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-1">How would you rate your overall experience?</label>
                <div className="flex items-center">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <button
                      key={star}
                    ...
                    >
                      <Star
                        className={`h-8 w-8 ${
                          (hoverRating || formData.rating) >= star ? 'text-yellow-400 fill-current' : 'text-gray-300'
                        }`}
                      />
                    </button>
                  ))}
              ...
              <div className="mb-6">
                <label htmlFor="feedback" className="block text-sm font-medium text-gray-700 mb-1">What did you like or dislike about the event?</label>
                <textarea
                  id="feedback"
                  name="feedback"
                  rows={4}
              ...
              <div className="pt-4 mb-6 border-t border-gray-200">
                ...
                <p className="mt-2 text-xs text-gray-500">We'll never share your personal information with anyone else.</p>
              </div>
